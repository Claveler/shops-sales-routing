...
export const initialCartEvents: CartEventGroup[] = [
  ...
  // Stranger Things event (non-seated, demonstrates multi-event cart)
  {
    id: 'evt-005--ts-005-02',
    eventId: 'evt-005',
    timeslotId: 'ts-005-02',
    eventName: 'Stranger Things: The Experience',
    eventImageUrl: EVENT_THUMBNAIL_BY_ID['evt-005'],
    location: 'IFEMA',
    date: 'Fri, May 1, 5:00 PM',
    isExpanded: true,
    items: [
      {
        id: 'ci-st-1',
